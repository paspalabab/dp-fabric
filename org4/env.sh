...
export SET_COUCHDB_HOST=couchdb3
export SET_COUCHDB_USER=admin
export SET_COUCHDB_PASSWORD=adminpw
export SET_COUCHDB_LOCAL_PORT=5984
export SET_COUCHDB_HOST_PORT=5987
export SET_PEER_LISTENPORT=8531
export SET_CHAINCODE_SERPORT=8532
export SET_OPERATIONS_LISTENPORT=8533
export SET_CHAINCODE_CONFIG='{"peername":"peer0org4"}'

# 1.Home path of config files fetched by ca client from ca server
THIS_ORG_HOST=org4.example.com
HOST_NAME_ABRR=Org4
...
ORDERER_CA=${PWD}/../orderer4/organizations/tlsca/tlsca.example.com-cert.pem
CA_REG_ORDERER_HOST=orderer4.example.com
ORDERER_SERVICE_ADDRESS=${CA_REG_ORDERER_HOST}:8053
