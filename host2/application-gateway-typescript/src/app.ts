...
const cryptoPath = envOrDefault('CRYPTO_PATH', path.resolve(__dirname, '..', '..', 'org2', 'organizations', 'peerOrganizations', 'org2.example.com'));
...
const peerEndpoint = envOrDefault('PEER_ENDPOINT', 'localhost:8511');
