...
export SET_COUCHDB_HOST=couchdb1
export SET_COUCHDB_USER=admin
export SET_COUCHDB_PASSWORD=adminpw
export SET_COUCHDB_LOCAL_PORT=5984
export SET_COUCHDB_HOST_PORT=5985
export SET_PEER_LISTENPORT=8511
export SET_CHAINCODE_SERPORT=8512
export SET_OPERATIONS_LISTENPORT=8513
export SET_CHAINCODE_CONFIG='{"peername":"peer0org2"}'

# 1.Home path of config files fetched by ca client from ca server
THIS_ORG_HOST=org2.example.com
HOST_NAME_ABRR=Org2
...
ORDERER_CA=${PWD}/../orderer2/organizations/tlsca/tlsca.example.com-cert.pem
CA_REG_ORDERER_HOST=orderer2.example.com
ORDERER_SERVICE_ADDRESS=${CA_REG_ORDERER_HOST}:8051
