...
docker exec fabric-cli /bin/sh -c "cd ${FABRIC_CLI_WORK_HOME}/org6; pwd; ./query.sh; ./fetchCurChanConfig.sh ${FABRIC_CLI_WORK_HOME}/configtx"
...
docker exec fabric-cli /bin/sh -c "cd ${FABRIC_CLI_WORK_HOME}/org1; pwd; ./query.sh; ./fetchCurChanConfig.sh ${FABRIC_CLI_WORK_HOME}/configtx"
