...
CA_REG_ORDERER_NAME=orderer5
CA_REG_ORDERER_PW=ordererpw
CA_REG_ORDERER_ADMIN_NAME=orderer5Admin
...
export SET_GENERAL_LISTENPORT=8054
export SET_ADMIN_LISTENADDRESS_PORT=8154
export SET_OPERATIONS_LISTENADDRESS_PORT=8254
