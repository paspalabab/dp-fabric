...
export SET_COUCHDB_HOST=couchdb5
export SET_COUCHDB_USER=admin
export SET_COUCHDB_PASSWORD=adminpw
export SET_COUCHDB_LOCAL_PORT=5984
export SET_COUCHDB_HOST_PORT=5989
export SET_PEER_LISTENPORT=8551
export SET_CHAINCODE_SERPORT=8552
export SET_OPERATIONS_LISTENPORT=8553
export SET_CHAINCODE_CONFIG='{"peername":"peer0org6"}'

# 1.Home path of config files fetched by ca client from ca server
THIS_ORG_HOST=org6.example.com
HOST_NAME_ABRR=Org6
...
NEW_ORG_DEFINITION_CONFIG_PATH=${PWD}/newOrgConfigtx
